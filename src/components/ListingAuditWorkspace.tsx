...
export default function ListingAuditWorkspace() {
  ...
  async function copyAuditPackage() { try { await navigator.clipboard.writeText(auditPackageText()); setNotice("Audit package copied. Paste it into the Codex conversation for analysis."); } catch { setNotice("Copy failed. Browser clipboard permission may be blocked."); } }
