...
type Props = { state: EtsyOperationsState; onCommit: (next: EtsyOperationsState, message: string) => Promise<void> };
...
export default function ProductFactsGate({ state, onCommit }: Props) {
